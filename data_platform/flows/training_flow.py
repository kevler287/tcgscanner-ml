...
def extract():
    ...
    from data_platform.etl.extract import main as run_extract
    run_extract()
...
def transform():
    ...
    from data_platform.etl.transform import main as run_transform
    run_transform()
...
def evaluate(run_dir: Path):
    ...
    from data_platform.etl.evaluate import evaluate as run_evaluate
...
def load(model_version: str, model_type: str, run_dir: Path, eval_metrics: dict):
    ...
    from data_platform.etl.load import load as run_load
